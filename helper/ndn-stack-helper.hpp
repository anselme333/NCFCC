...
public:
  ...
  ///////////////////////////////////////////////////////////////////////
  // Added by Anselme
 void MemoryEfficient(bool enable,uint32_t totalbuffer, uint32_t min_bufferthreshold);
 void Popularity_based(bool enable);
 void EnableLimits (bool enable = true, Time avgRtt=Seconds(0.1), uint32_t avgContentObject=1100, uint32_t avgInterest=40);
  ...
  //Added by Anselme
    ...
    uint32_t GetFlowNumber(ndn::Name prefix);
...
private:
  ...
  //Added by Anselme
    ...
    bool a_CMTB;
    bool popularity_based_activated;
    double Nflows;
