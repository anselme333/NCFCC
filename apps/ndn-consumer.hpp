...
public:
  ...
  ///////////////////////////////////////////////////////////////////////////////
   // added by anselme
  // virtual void OnRsr(shared_ptr< const Interest > ReduceSengRate);
  //virtual void OnRsr(shared_ptr<const Data> ReduceSengRate );
  virtual void OnRsr(std::shared_ptr<const ndn::Interest> ReduceSendRate);

 //////////////////////////////////////////////////////////////////////
  //added by anselme
  virtual void
    OnTimeout1(uint32_t sequenceNumber);
  virtual void
    fast_retransmission(uint32_t sequenceNumber);
...
protected:
  ...
  int retransm; //Defined by group Anselme & Thai
