 ...
 */
class FullyDistributed : public Consumer {
public:
  static TypeId
  GetTypeId();
  ...
  ///////////////////////////////////////////////////////////////////////
  //Modified by Anselme
   virtual void OnTimeout1(uint32_t sequenceNumber);
  //virtual void OnRsr(shared_ptr< const Data> ReduceSendingRate);
   virtual void OnRsr(std::shared_ptr<const ndn::Interest> ReduceSendRate);
   virtual void fast_retransmission(uint32_t sequenceNumber);
